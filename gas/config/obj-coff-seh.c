...
/* Unwind codes packing for AArch64 is described at
  ...
  {NULL,		  5, 0, 3, AARCH64_UNOP_ALLOCS,      4, 0, 0,
   0,  alloc_s, 1},
  {NULL,		 11, 0, 5, AARCH64_UNOP_ALLOCM,      4, 0, 0,
   0,  alloc_m, 2},
  {NULL,		 24, 0, 8, AARCH64_UNOP_ALLOCL,      4, 0, 0,
   0,  alloc_l, 4},
  {".seh_save_reg",	  6, 4, 6, AARCH64_UNOP_SAVEREG,     3, 0, 0,
   19, save_reg, 2},
  {".seh_save_reg_x",	  5, 4, 7, AARCH64_UNOP_SAVEREGX,    3, 1, 0,
   19, save_reg_x, 2},
  {".seh_save_regp",	  6, 4, 6, AARCH64_UNOP_SAVEREGP,    3, 0, 0,
   19, save_regp, 2},
  {".seh_save_regp_x",	  6, 4, 6, AARCH64_UNOP_SAVEREGPX,   3, 1, 0,
   19, save_regp_x, 2},
  {".seh_save_fregp",	  6, 3, 7, AARCH64_UNOP_SAVEFREGP,   3, 0, 0,
   8,  save_fregp, 2},
  {".seh_save_fregp_x",   6, 3, 7, AARCH64_UNOP_SAVEFREGPX,  3, 1, 0,
   8,  save_fregp_x, 2},
  {".seh_save_freg",	  6, 3, 7, AARCH64_UNOP_SAVEFREG,    3, 0, 0,
   8,  save_freg, 2},
  {".seh_save_freg_x",	  5, 3, 8, AARCH64_UNOP_SAVEFREGX,   3, 1, 0,
   8,  save_freg_x, 2},
  {".seh_save_lrpair",	  6, 3, 7, AARCH64_UNOP_SAVELRPAIR,  3, 0, 1,
   19, save_lrpair, 2},
  {".seh_save_fplr",	  6, 0, 2, AARCH64_UNOP_SAVEFPLR,    3, 0, 0,
   0,  save_fplr, 1},
  {".seh_save_fplr_x",	  6, 0, 6, AARCH64_UNOP_SAVEFPLRX,   3, 1, 0,
   0,  save_fplr_x, 1},
  {".seh_save_r19r20_x",  5, 0, 3, AARCH64_UNOP_SAVER19R20X, 3, 0, 0,
   0,  save_r19r20_x, 1},
  {".seh_add_fp",	  8, 0, 8, AARCH64_UNOP_ADDFP,	     0, 0, 0,
   0,  add_fp, 2},
  {".seh_set_fp",	  0, 0, 8, AARCH64_UNOP_SETFP,	     0, 0, 0,
   0,  set_fp, 1},
  {".seh_save_next",	  0, 0, 8, AARCH64_UNOP_SAVENEXT,    0, 0, 0,
   0,  save_next, 1},
  {".seh_nop",		  0, 0, 8, AARCH64_UNOP_NOP,	     0, 0, 0,
   0,  nop, 1},
  {".seh_pac_sign_lr",	  0, 0, 8, AARCH64_UNOP_PACSIGNLR,   0, 0, 0,
   0,  pac_sign_lr, 1},
  {NULL,		  0, 0, 8, AARCH64_UNOP_END,	     0, 0, 0,
   0,  end, 1},
};
#endif
...
free_seh_ctx (struct seh_context *seh_ctx)
{
  ...
  XDELETEVEC (seh_ctx->aarch64_ctx.epilogue_scopes);
#endif
  free (seh_ctx);
}
